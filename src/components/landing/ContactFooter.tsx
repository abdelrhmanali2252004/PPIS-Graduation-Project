  ...
  return (
    <footer id="contact" className="bg-body px-4 py-14 text-white">
      <div className="mx-auto max-w-6xl">
        <h2 className="mb-8 text-center text-2xl font-bold text-gold">اتصل بنا</h2>
        <div className="mb-8 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-4 text-center sm:col-span-2 lg:col-span-1">
            ...
            <div className="text-sm font-semibold text-white/90">أسيوط، جمهورية مصر العربية</div>
          </div>
        </div>
        ...
        <p className="text-center text-xs text-white/50">
          © {new Date().getFullYear()} NextVenture OS. جميع الحقوق محفوظة.
        </p>
        <p className="mt-2 text-center text-sm font-medium text-gold/80">✦ Magic</p>
      </div>
    </footer>
  )
}
