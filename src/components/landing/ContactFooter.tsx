      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-8 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-4 text-center sm:col-span-2 lg:col-span-1">
            ...
            <div className="mb-1 text-xs text-white/60">{t('landing.contact.address')}</div>
        ...
        <div className="mb-8 flex justify-center gap-4">
          <a href="#" className="text-slateMuted transition-colors hover:text-gold" aria-label="LinkedIn">
        ...
        <p className="text-center text-xs text-white/50">
          © {new Date().getFullYear()} FkraTech {t('landing.contact.copyright')}
        </p>
      </div>
    </footer>
  )
